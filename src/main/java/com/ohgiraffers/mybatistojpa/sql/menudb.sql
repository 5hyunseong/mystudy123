...
(
    ...
    menu_picture_name VARCHAR(255)NOT NULL COMMENT '메뉴사진이름',
    menu_picture_extension VARCHAR(255) NOT NULL COMMENT '메뉴사진확장자',
    -- table level constraints
...
# drop table tbl_member_section06_subsection02;
COMMIT;